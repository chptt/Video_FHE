...
async function main() {
  ...
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  console.log("\n📝 Next steps:");
  console.log(`   1. Copy the contract address into your .env.local:`);
  console.log(`      NEXT_PUBLIC_CIPHERSTREAM_CONTRACT_ADDRESS=${address}`);
  console.log(`   2. Add it to Vercel environment variables with the same key.`);
  console.log(`   3. (Optional) Verify on Arbiscan:`);
