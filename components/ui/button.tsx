  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-purple-600/40 bg-transparent text-purple-300 hover:bg-purple-600/10 hover:border-purple-500",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        cyber:
          "bg-cyan-600/20 border border-cyan-600/40 text-cyan-300 hover:bg-cyan-600/30",
        success:
          "bg-green-600/20 border border-green-600/40 text-green-300 hover:bg-green-600/30",
        warning:
